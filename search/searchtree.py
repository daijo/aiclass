...
print "Homework Search Tree 2"

nodeEleven = TreeNode("11", None, False)
nodeTwelve = TreeNode("12", None, False)
goal = TreeNode("Goal", None, True)


nodeFive = TreeNode("5", None, False)
nodeSix = TreeNode("6", None, False)
nodeSeven = TreeNode("7", [nodeEleven, nodeTwelve], False)
nodeEight = TreeNode("8", [goal], False)
nodeNine = TreeNode("9", None, False)
nodeTen = TreeNode("10", None, False)

nodeTwo = TreeNode("2", [nodeFive, nodeSix], False)
nodeThree = TreeNode("3", [nodeSeven, nodeEight], False)
nodeFour = TreeNode("4", [nodeNine, nodeTen], False)
